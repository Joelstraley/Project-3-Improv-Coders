    ...
    return (
        <div className="bg-gradient-to-r from-blue-100 to-blue-300 p-10">
            ...
            <div className="flex justify-between py-10 mx-15">
                <div className="imageGillian rounded-2xl border-4 border-solid border-gray-500 hover:bg-blue-300 p-5 hover:shadow-inner shadow-2xl"><img
                ...
                <div className="imageKofi rounded-2xl border-4 border-solid border-gray-500 hover:bg-blue-300 p-5 hover:shadow-inner shadow-2xl"><img src={Kofi} className="h-72 rounded-2xl  mx-auto" alt="this is Kofi's image" />
                ...
                <div className="imageJoel rounded-2xl border-4 border-solid border-gray-500 hover:bg-blue-300 p-5 hover:shadow-inner shadow-2xl"><img src={Joel} className="h-72 rounded-2xl mx-auto" alt="this is Joel's image" />
